...
macro_rules! tag_table {
    ($macro:path) => {
        $macro! {
            ...
            [19 Rotation      Byte      unbox   <crate::core::math::rotation::Rotation>         ]
            [20 Flip          Byte      unbox   <crate::core::math::flip::Flip>                 ]
            [21 Orientation   Byte      unbox   <crate::core::math::orientation::Orientation>   ]
